...
builder.Services.AddDbContext <WineInventoryContext> (dbContextOptions => dbContextOptions.UseSqlite(builder.Configuration["ConnectionStrings:WineInventoryAPIDBConnectionString"]));
